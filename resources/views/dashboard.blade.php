...
@section('content')
    <x-container>
        ...
        <div class="p-4">
            ...
            <p class="mt-2 opacity-50" x-data="{ date: new Date() }">Today is 
                <span class="font-medium" x-text="date.toLocaleDateString('en-UK', {
                    weekday: 'long',
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
                ...
                <div class="space-y-3 mt-10">
                    ...
                    @empty
                        <div class="py-10 border rounded border-grey">
                            <h1 class="text-center text-dark-blue">No upcoming tasks.</h1>
                        </div>
                    @endforelse
                </div>
